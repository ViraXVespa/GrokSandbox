...
public class ChatBetPlugin extends Plugin {
    ...
    private void handleBetCommand(String username, String message) {
        ...
        try {
            ...
            betManager.placeWager(username, pollId, optionIndex, amount);
    ...
    public void onItemContainerChanged(ItemContainerChanged event) {
        ...
        if (!(activeModule instanceof com.vxv.chatbet.module.PickpocketingModule)) {
            checkDelta(lastQtys, currentQtys, ITEM_ETC, true);
        }
        lastQtys.clear();
    ...
    public void onGameTick(GameTick event) {
        ...
        if (xpToGoal <= 0 && lastCheckedXpToGoal > 0) betManager.onGameEvent(GameEventType.GOAL_30_REACHED);
    ...
    public int getXpToThirtyPct() { if (activeModule instanceof com.vxv.chatbet.module.PickpocketingModule) return ((com.vxv.chatbet.module.PickpocketingModule) activeModule).getXpToThirtyPct(); return 0; }
    public int getElvesToThirtyPct() { if (activeModule instanceof com.vxv.chatbet.module.PickpocketingModule) return ((com.vxv.chatbet.module.PickpocketingModule) activeModule).getElvesToThirtyPct(); return 0; }
